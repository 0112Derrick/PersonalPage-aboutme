...
export default function Footer() {
  const linkedinLink = "https://www.linkedin.com/in/derrick-v-williams-jr-/";
  const githubLink = "https://github.com/0112Derrick";
  const instagramLink = "https://www.instagram.com/adroit_nature/";
  return (
    <Container className="padding-sm bg-color-4 width-100 margin-0 footer-section">
      <Row>
        <Col>
          <a href={linkedinLink}>
            <svg
      ...
      <Row className="footer-text-section">
        <p>Created by Derrick Williams</p>
